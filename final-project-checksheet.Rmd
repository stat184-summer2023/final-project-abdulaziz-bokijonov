...
(A) .Rmd Line numbers where at least two different data sources are imported:  23-27


(B) .Rmd Line numbers for inspecting data intake: 27-30 
...
(A) .Rmd Line number(s) for general data wrangling: 102-130


(B) .Rmd Line number(s) for a join operation: 95


(C) .Rmd Line number(s) for use of reduction and/or transformation functions: 127-130, 74-96
...
(F) .Rmd Line number(s) for use of user-defined functions: 67-70, 77


(G) .Rmd Line number(s) for use of loops and/or control flow: 78
...
(A) .Rmd Line number(s) for use of multiple different geoms on a single plot:  146-151

(B) .Rmd Line number(s) for use of multiple aesthetics:  
153-158

(C) .Rmd Line number(s) for use of layered graphics:  174-179
